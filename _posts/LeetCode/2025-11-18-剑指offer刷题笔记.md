...
![]( /img/in-post/leetcode/sword-offer/4.png)
...
![line](/img/in-post/leetcode/sword-offer/4_1.png)
...
![二叉树]( /img/in-post/leetcode/sword-offer/7.png)
...
![迭代1]( /img/in-post/leetcode/sword-offer/7_2.png)

![迭代2]( /img/in-post/leetcode/sword-offer/7_3.png)
...
+ 第二部分位于第一部分的右侧，是二叉搜索树根节点的右子树中的所有元素，均大于根节点。该部分可能为空。
...
![]( /img/in-post/leetcode/sword-offer/35_1.png)
...
![]( /img/in-post/leetcode/sword-offer/35_2.png)
...
![]( /img/in-post/leetcode/sword-offer/35_3.png)
...
先根据每个节点的 next 信息，复制所有的节点，然后根据节点的值逐个确定其 random 信息。这是一个时间复杂度为 ``O(n^2)`` 的方法，并且当节点的取值存在重复时，无法正确确定每个节点的random信息。这是我第一时间想到的方法，提交之后运行结果错误。
...
![]( /img/in-post/leetcode/sword-offer/36_1.png)

我们希望将这个二叉搜索树转化为双向循环链表。链表中的每个节点都有一个前驱和后继指针。对于双向循环链表，第一个节点的前驱是最后一个节点，最后一个节点的后继是第一个节点。

下图展示了上面的二叉搜索树转化成的链表。“head” 表示指向链表中有最小元素的节点。

![]( /img/in-post/leetcode/sword-offer/36_2.png)
...
![](/img/in-post/leetcode/sword-offer/52_1.png)

在节点 c1 开始相交。

**示例 1：**

![](/img/in-post/leetcode/sword-offer/52_2.png)
...
![](/img/in-post/leetcode/sword-offer/52_3.png)
...
![](/img/in-post/leetcode/sword-offer/52_4.png)
...
![](/img/in-post/leetcode/sword-offer/68.png)
...
![](/img/in-post/leetcode/sword-offer/68_II.png) 
